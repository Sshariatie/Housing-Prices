...
```{r}
getwd() 
testdf <- read.csv(file= "C:/Users/Owner/Desktop/Projects/Housing Prices/CSV_txt_files/test.csv",header = T,stringsAsFactors = F, na.strings = c("","NA"), sep = ',')
traindf <- read.csv(file= "C:/Users/Owner/Desktop/Projects/Housing Prices/CSV_txt_files/train.csv",header = T,stringsAsFactors = F, na.strings = c("","NA"), sep = ',') 
